...
public class AKToolsSource implements BaseSource {
  ...
  public List<StockInfoDTO> getAllAStockInfo() {
    ...
    HttpRequest httpRequest =
        HttpRequest.newBuilder()
            ...
            .build();
    try {
      HttpResponse<List<StockInfoDTO>> response =
          httpClient.send(httpRequest, new JsonBodyHandler<>(new TypeReference<>() {}));
  ...
  @Override
  public List<StockPriceDTO> getAStockPrice(
      String code, String startDate, String endDate, String adjust) {
    ...
    try {
      ...
      HttpResponse<List<StockPriceDTO>> response =
          httpClient.send(request, new JsonBodyHandler<>(new TypeReference<>() {}));
      if (response.statusCode() != 200) {
